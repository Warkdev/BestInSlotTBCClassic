...
function BIS:OpenConfigPane(args)
    InterfaceOptionsFrame_OpenToCategory("BestInSlotTBCClassic");
    InterfaceOptionsFrame_OpenToCategory("BestInSlotTBCClassic");
end

local function ShowHelp(args)
    BIS:logmsg("BestInSlotTBCClassic usage: ", LVL_INFO);
...
local function HandleTooltip(args)
    BestInSlotTBCClassicDB.options.bistooltip = not BestInSlotTBCClassicDB.options.bistooltip;
    if BestInSlotTBCClassicDB.options.bistooltip then
...
function PrintVars(args)
    --BIS:logmsg("Log level: ", BestInSlotTBCClassicDB.loglevel, INFO);
    --BIS:logmsg("Hide Minimap Icon: ", BestInSlotTBCClassicDB.minimap.hide, INFO);
    --BIS:logmsg("Minimap Icon Position: "..BestInSlotTBCClassicDB.minimap.minimapPos, INFO);
...
local function Reset(args)
    ResetDefaults();
    UpdateMinimapIcon();
    BIS:logmsg("BestInSlotTBCClassic has been reset to default values.", LVL_DEBUG);
end
